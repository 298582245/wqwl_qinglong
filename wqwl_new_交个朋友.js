 ...
 * 描述：微信小程序交个朋友，抓包请求头的Authorization，格式：Authorization1#备注（备注可选）
 * 环境变量：wqwl_jgpy，多个换行或新建多个变量（不能混合使用）
 * 环境变量描述：
 * cron: 1 8 * * *
 */
...
//环境变量
const ckName = 'wqwl_jgpy';
//脚本名称
const scriptName = '微信小程序交个朋友';
//本地版本
const version = 1.0;
//是否需要文件存储
    ...
    class Task extends wqwlkj.WQWLBaseTask {
        ...
        async init() {
            ...
            this.headers = {
                ...
                'xy-extra-data': 'appid=wx3b294e7a0ba29bc3;version=2.19.1;envVersion=release;senceId=1005',
                envVersion: 'release',
                version: '2.19.1',
                Accept: '*/*',
                Referer: 'https://servicewechat.com/wx3b294e7a0ba29bc3/91/page-frame.html',
